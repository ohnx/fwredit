/* global Physijs, THREE, Stats, SimplexNoise */
...
initScene = function(viewport) {
	let h = viewport.offsetHeight;
	...
	ground_material = Physijs.createMaterial(
		new THREE.MeshLambertMaterial({ map: loader.load( 'assets/plywood.jpg' ) }),
		.8, // high friction
		.4 // low restitution
	);
	...
	json_loader.load( "assets/mustang.js", function( car, car_materials ) {
		json_loader.load( "assets/mustang_wheel.js", function( wheel, wheel_materials ) {
...
window.onload = function() {initScene(document.getElementById('viewport'));};
